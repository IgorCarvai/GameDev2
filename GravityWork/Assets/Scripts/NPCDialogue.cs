    ...
    public void checkConditions(int player, int textNumber)
    {
        ...
        if (speaker == "Avin")
        {
            ...
            else if (sceneNumber >= 4)//cutscene 2
            {
				...
				if (textNumber == 1)
					dialogueLine = "Here are the recipes: \n5 Screw + 5 Wire + 3 Piston make the Engine. \n10 Screw + 10 Steel 2 Piston make the Solid Rocket Booster.\n10 Wire + 15 Screw + 10 Steel make the Fuel Tank. \n5 Steel + 10 Screw make the Radiator.";
				if (textNumber == 2)
					dialogueLine = "10 Mirror Shards + 5 Steel + 1 Wire make the Solar Panels.\n5 Cog + 5 Wire + 10 Steel make the Sensors.";
				if (textNumber == 3)
					dialogueLine = "5 Steel + 1 Wire make a Piston.\n1 Cog + 1 Steel Screw.\n1 Steel + 1 Bone make a Cog.";  
			}
        }
